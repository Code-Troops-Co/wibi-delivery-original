<?php $__env->startSection('title', __('labels.roles')); ?>
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <div>
                                <h3 class="card-title"><?php echo e(__('labels.roles')); ?></h3>
                                            ...
                                            <div class="col text-end">
                                                <a href="#" class="btn btn-6 btn-outline-primary" data-bs-toggle="modal"
                                                   data-bs-target="#role-modal">
                                                    ...
                                                    <?php echo e(__('labels.add_new_role')); ?>
...
<?php $component = App\View\Components\Datatable::resolve(['id' => 'roles-table','columns' => $columns,'route' => ''.e(route('admin.roles.datatable')).'','options' => ['order' => [[0, 'desc']],'pageLength' => 10,]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
            ...
            >
                <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
                    <div class="modal-content">
                        <form class="form-submit" action="<?php echo e(url('admin/roles')); ?>" method="POST">
                            <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.admin.app',['page' => $menuAdmin['roles_permissions']['active'] ?? "", 'sub_page' => $menuAdmin['roles_permissions']['route']['roles']['sub_active'] ?? "" ], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/wibi-backend/resources/views/admin/roles/index.blade.php ENDPATH**/ ?>