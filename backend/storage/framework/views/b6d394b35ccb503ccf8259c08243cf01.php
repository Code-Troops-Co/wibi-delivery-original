<?php use App\Enums\ActiveInactiveStatusEnum; ?>


<?php $__env->startSection('title', __('labels.faqs')); ?>
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <div>
                            <h3 class="card-title"><?php echo e(__('labels.faqs')); ?></h3>
                            ...
                            <div class="row g-2">
                                <div class="col-auto">
                                    <select class="form-select" id="statusFilter">
                                        ...
                                        <?php $__currentLoopData = ActiveInactiveStatusEnum::values(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $type): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<?php $component = App\View\Components\Datatable::resolve(['id' => 'faqs-table','columns' => $columns,'route' => ''.e(route('admin.faqs.datatable')).'','options' => ['order' => [[0, 'desc']],'pageLength' => 10,]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
            ...
            <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="faq-modal-title"><?php echo e(__('labels.add_faq')); ?></h5>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <form class="form-submit" id="faq-form" method="POST" action="<?php echo e(route('admin.faqs.store')); ?>">
                        <?php echo csrf_field(); ?>
                                ...
                                <div class="col-lg-12">
                                    <div class="mb-3">
                                        ...
                                        <select class="form-select text-capitalize" id="status" name="status">
                                            <?php $__currentLoopData = ActiveInactiveStatusEnum::values(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $status): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<?php echo $__env->make('layouts.admin.app', ['page' => $menuAdmin['faqs']['active'] ?? ""], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/wibi-backend/resources/views/admin/faqs/index.blade.php ENDPATH**/ ?>