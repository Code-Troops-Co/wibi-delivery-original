...
<?php $component = App\View\Components\Datatable::resolve(['id' => 'brands-table','columns' => $columns,'route' => ''.e(route('seller.brands.datatable')).'','options' => ['order' => [[0, 'desc']],'pageLength' => 10,]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php echo $__env->make('layouts.seller.app', ['page' => $menuSeller['brands']['active'] ?? ""], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/wibi-backend/resources/views/seller/brands/index.blade.php ENDPATH**/ ?>