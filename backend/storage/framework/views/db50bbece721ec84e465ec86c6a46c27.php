                                ...
                                <div class="row g-2">
                                    ...
                                    <div class="col-auto">
                                        <select class="form-select" id="productVerificationStatusFilter">
                                            ...
                                            <?php $__currentLoopData = ProductVarificationStatusEnum::values(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $type): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option
                                                    value="<?php echo e($type); ?>"><?php echo e(ucfirst(\Illuminate\Support\Str::replace("_", " ",$type))); ?></option>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        </select>
                                    </div>
                                    <div class="col-auto">
...
<?php $component = App\View\Components\Datatable::resolve(['id' => 'products-table','columns' => $columns,'route' => ''.e(route('admin.products.datatable')).'','options' => ['order' => [[0, 'desc']],'pageLength' => 10,]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php echo $__env->make('layouts.admin.app', ['page' => $menuAdmin['products']['active'] ?? "", 'sub_page' => $menuAdmin['products']['route'][$isApprovalView ? 'pending_approval_products' : 'products']['sub_active']], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/wibi-backend/resources/views/admin/products/index.blade.php ENDPATH**/ ?>