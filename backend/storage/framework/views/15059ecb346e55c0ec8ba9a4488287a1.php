<aside class="navbar navbar-vertical navbar-expand-lg overflow-auto" data-bs-theme="dark">
    <div class="container-fluid">
        ...
        <div class="navbar-brand navbar-brand-autodark">
            ...
            <a href="<?php echo e(url($panel)); ?>">
                <img src="<?php echo e(!empty($systemSettings['logo']) ? $systemSettings['logo'] : asset('logos/hyper-local-logo-white.png')); ?>"
                     alt="<?php echo e($systemSettings['appName'] ?? ""); ?>" width="150">
            </a>
        </div>
        ...
        <div class="collapse navbar-collapse" id="sidebar-menu">
            <ul class="navbar-nav pt-lg-3">
                ...
                <?php $__currentLoopData = $menuItems; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <li class="nav-item <?php echo e($isDropdown ? 'dropdown' : ''); ?> <?php echo e($isActive ? 'active' : ''); ?>">
                        <?php if($isDropdown): ?>
                            <a class="nav-link dropdown-toggle <?php echo e($isActive ? 'active show' : ''); ?>"
                               href="#navbar-<?php echo e($key); ?>" data-bs-toggle="dropdown" data-bs-auto-close="false"
                               aria-expanded="<?php echo e($isActive ? 'true' : 'false'); ?>">
                                <span class="nav-link-icon d-md-none d-lg-inline-block">
                                    <i class="ti <?php echo e($item['icon']); ?> fs-2"></i>
                                </span>
                                <span class="nav-link-title"><?php echo e(__($item['title'])); ?></span>
                            </a>
                            <?php if(count($visibleSubRoutes) > 0): ?>
                                <div class="dropdown-menu <?php echo e($isActive ? 'show' : ''); ?>">
                                    <?php $__currentLoopData = $visibleSubRoutes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $subRoute): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <?php
    ...
    //                                        dd($subRoute['sub_title'])
                                        ?>
                                        <a class="dropdown-item <?php echo e($isSubActive ? 'active' : ''); ?>"
                                           href="<?php echo e(route($subRoute['sub_route'],$subRoute['route_param'] ?? [])); ?>">
                                            <i class="ti ti-point<?php echo e($isSubActive ? '-filled' : ''); ?> fs-2"></i><?php echo e(__($subRoute['sub_title'])); ?>
                            ...
                            <?php endif; ?>
                        <?php else: ?>
                            <a class="nav-link <?php echo e($isActive ? 'active' : ''); ?>" href="<?php echo e(route($item['route'])); ?>">
...
<?php /**PATH /var/www/wibi-backend/resources/views/layouts/partials/_sidebar.blade.php ENDPATH**/ ?>