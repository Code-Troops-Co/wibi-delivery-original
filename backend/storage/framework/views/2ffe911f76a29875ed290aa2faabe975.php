<?php $__env->startSection('title', __('labels.admin_login')); ?>
        ...
        <div class="container-fluid">
            <div class="alert alert-warning mt-2" role="alert">
                ...
                <div>
                    ...
                    If you can't login to admin panel, please <span><a href="<?php echo e(route('admin.login')); ?>" target="_blank"
        ...
        <div class="container container-tight py-4">
            ...
            <div class="card card-md">
                <div class="card-body">
                    ...
                    <form id="login-form" action="<?php echo e(route('admin.login.post')); ?>" method="post" autocomplete="off"
                        novalidate>
                        ...
                        <div class="mb-2">
                            <label class="form-label">
                                Password
                                <span class="form-label-description"><a href="<?php echo e(route('admin.password.request')); ?>">I
                            ...
                            <div class="row g-3">
                                <div class="col-12">
                                    <div class="border rounded p-3 h-100">
                                        <div class="d-flex justify-content-between align-items-center mb-2">
                                            <strong><?php echo e(__('labels.admin_credentials')); ?></strong>
                                            <button type="button" class="btn btn-sm btn-outline-primary copy-cred"
                                                data-target-form="#login-form"
                                                data-email="<?php echo e(env('DEMO_ADMIN_EMAIL', 'hyperlocaladmin@gmail.com')); ?>"
                                        ...
                                        <div class="text-muted"><?php echo e(__('labels.email')); ?>:
                                            <code><?php echo e(env('DEMO_ADMIN_EMAIL', 'hyperlocaladmin@gmail.com')); ?></code>
                                        </div>
                                        <div class="text-muted"><?php echo e(__('labels.password')); ?>:
                                            <code><?php echo e(env('DEMO_PASSWORD', '12345678')); ?></code>
                                        </div>
                                    </div>
                                </div>
                            </div>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.admin.guest', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/wibi-backend/resources/views/admin/auth/login.blade.php ENDPATH**/ ?>