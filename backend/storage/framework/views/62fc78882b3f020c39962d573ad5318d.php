<?php $__env->startSection('title', __('labels.bulk_upload') . ' ' . __('labels.brands')); ?>
...
window.BULK_UPLOAD_CFG = {
  uploadUrl: "<?php echo e(route('admin.brands.bulk-upload')); ?>",
  ...
  <div class="col-12">
    <div class="card">
      <div class="card-header">
        <div>
          <h3 class="card-title"><?php echo e(__('labels.bulk_upload')); ?> <?php echo e(__('labels.brands')); ?></h3>
          ...
          <div class="col-12">
            <div class="alert alert-info" role="alert">
              ...
              <ul class="mb-2">
                ...
                <li><?php echo e(__('labels.optional_fields') ?? 'Optional fields'); ?>: description, status, scope_type, scope_id, category_title</li>
              </ul>
              <a href="<?php echo e(route('admin.brands.bulk-template')); ?>" class="btn btn-outline-primary btn-sm"><?php echo e(__('labels.download_template')); ?></a>
            </div>
          </div>
          <div class="col-12">
            <form id="bulk-upload-form" enctype="multipart/form-data" Method="POST" action="<?php echo e(route('admin.brands.bulk-upload')); ?>">
              <?php echo csrf_field(); ?>
              ...
              <div class="mt-3 d-flex gap-2">
                ...
                <a href="<?php echo e(route('admin.brands.bulk-template')); ?>" class="btn btn-outline-secondary"><?php echo e(__('labels.download_template')); ?></a>
              </div>
            </form>
          </div>
        </div>
...
<?php echo $__env->make('layouts.admin.app', ['page' => $menuAdmin['brands']['active'] ?? ""], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/wibi-backend/resources/views/admin/brands/bulk_upload.blade.php ENDPATH**/ ?>