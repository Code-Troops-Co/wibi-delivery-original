<?php $__env->startSection('title', __('labels.customers')); ?>
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <div>
                        <h3 class="card-title"><?php echo e(__('labels.customers')); ?></h3>
...
<?php $component = App\View\Components\Datatable::resolve(['id' => 'customers-table','columns' => $columns,'route' => ''.e(route('admin.customers.datatable')).'','options' => ['order' => [[0, 'desc']], 'pageLength' => 10]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php echo $__env->make('layouts.admin.app', ['page' => $menuAdmin['customers']['active'] ?? ""], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/wibi-backend/resources/views/admin/customers/index.blade.php ENDPATH**/ ?>