                        ...
                        <div class="card-header">
                            ...
                            <div class="card-actions">
                                <div class="row g-2 align-items-center">
                                    ...
                                    <div class="col-auto">
                                        <a href="<?php echo e(route('admin.commissions.history')); ?>"
                                    ...
                                    <li class="nav-item" role="presentation">
                                        <a class="nav-link active" data-bs-toggle="tab" href="#tab-credits" role="tab"
                                           aria-selected="true">
                                            ...
                                            </svg><?php echo e(__('labels.payouts')); ?></a>
                                    </li>
                                    <li class="nav-item" role="presentation">
                                        <a class="nav-link" data-bs-toggle="tab" href="#tab-debits" role="tab"
                                           aria-selected="false">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                                ...
                                                <path d="M16 19h6"/>
                                            </svg><?php echo e(__('labels.returns_deductions')); ?></a>
                                    </li>
                                </ul>
                                <div class="tab-content pt-3">
                                    <div class="tab-pane active" id="tab-credits" role="tabpanel">
                                        <?php if($settlePermission): ?>
                                            <div class="mb-3">
                                                <button class="btn btn-primary" id="settle-all-btn">
                                                    ...
                                                    <?php echo e(__('labels.settle_all_commissions')); ?>
...
<?php $component = App\View\Components\Datatable::resolve(['id' => 'commissions-table','columns' => $columns,'route' => ''.e(route('admin.commissions.datatable')).'','options' => ['order' => [[0, 'desc']],'pageLength' => 10,]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
                                    ...
                                    <div class="tab-pane" id="tab-debits" role="tabpanel">
                                        <?php if($settlePermission): ?>
                                            <div class="mb-3">
                                                <button class="btn btn-primary" id="settle-all-debits-btn">
                                                    ...
                                                    <?php echo e(__('labels.settle_all_debits')); ?>
                                        ...
                                        <?php if (isset($component)) { $__componentOriginale217948d0aa10885800ec2994f6a95b1 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginale217948d0aa10885800ec2994f6a95b1 = $attributes; } ?>
<?php $component = App\View\Components\Datatable::resolve(['id' => 'debits-table','columns' => $columnsReturn,'route' => ''.e(route('admin.commissions.debits.datatable')).'','options' => ['order' => [[0, 'desc']],'pageLength' => 10,]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('datatable'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
        ...
        <div class="modal-dialog modal-sm modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body text-center py-4">
                    ...
                    <h3><?php echo e(__('labels.confirm_settlement')); ?></h3>
                    <div class="text-secondary"><?php echo e(__('labels.confirm_settlement_message')); ?></div>
                    <div class="mt-3">
                        <div class="text-muted"><?php echo e(__('labels.order_id')); ?>: <span id="settlement-order-id"></span>
                        </div>
                        <div class="text-muted"><?php echo e(__('labels.product')); ?>: <span id="settlement-product"></span></div>
                        <div class="text-muted"><?php echo e(__('labels.your_commission')); ?>: <span
                                id="settlement-commission"></span></div>
                        <div class="text-muted"><?php echo e(__('labels.amount_to_pay')); ?>: <span id="settlement-amount"></span>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col">
                                <button class="btn btn-primary w-100" id="confirmSettlement"
                                        data-bs-dismiss="modal"><?php echo e(__('labels.confirm')); ?></button>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="modal-dialog modal-sm modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body text-center py-4">
                    ...
                    <h3><?php echo e(__('labels.settle_all_commissions')); ?></h3>
                    <div class="text-secondary"><?php echo e(__('labels.settle_all_commissions_message')); ?></div>
                </div>
                <div class="modal-footer">
                    <div class="w-100">
                        <div class="row">
...
<?php echo $__env->make('layouts.admin.app', ['page' => $menuAdmin['seller_management']['active'] ?? "", 'sub_page' => $menuAdmin['seller_management']['route']['earning_settlement']['sub_active']], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/wibi-backend/resources/views/admin/commissions/index.blade.php ENDPATH**/ ?>