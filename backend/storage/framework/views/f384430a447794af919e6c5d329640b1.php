<?php use App\Enums\DateRangeFilterEnum;use App\Enums\Order\OrderItemStatusEnum;use Illuminate\Support\Str; ?>
...
<?php $component = App\View\Components\Datatable::resolve(['id' => 'orders-table','columns' => $columns,'route' => ''.e(route('seller.orders.datatable')).'','options' => ['order' => [[0, 'desc']],'pageLength' => 10,]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php echo $__env->make('layouts.seller.app', ['page' => $menuSeller['orders']['active'] ?? ""], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/wibi-backend/resources/views/seller/orders/index.blade.php ENDPATH**/ ?>