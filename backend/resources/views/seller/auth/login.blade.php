        ...
        <div class="container-fluid">
            <div class="alert alert-warning mt-2" role="alert">
                ...
                <div>
                    ...
                    If you can't login to seller panel, please <span><a href="{{ route('seller.login') }}"
        ...
        <div class="container container-tight py-4">
            <div class="text-center mb-4">
                <a href="." class="navbar-brand navbar-brand-autodark">
                    @if(($systemSettings['demoMode'] ?? false))
                    <img src="{{asset('logos/hyper-local-logo.png')}}" alt="{{$systemSettings['appName'] ?? ""}}"
                        width="150px">
                    @else
            ...
            <div class="card card-md">
                <div class="card-body">
                    ...
                    <form id="login-form" action="{{route('seller.login.post')}}" method="post" autocomplete="off"
                        novalidate>
                        @csrf
                        ...
                        <div class="mb-2">
                            <label class="form-label">
                                Password
                                <span class="form-label-description"><a href="{{route('seller.password.request')}}">I
                                ...
                                <div class="col-126">
                                    <div class="border rounded p-3 h-100">
                                        ...
                                        <div class="text-muted">{{ __('labels.email') }}:
                                            <code>{{ env('DEMO_SELLER_EMAIL', 'demoseller@gmail.com') }}</code></div>
