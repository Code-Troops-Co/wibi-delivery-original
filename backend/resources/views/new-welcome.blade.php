...
<head>
    <link rel="icon" type="image/png" sizes="32x32" href="{{asset('assets/landing/site-favicon.png')}}" />
    ...
    <header class="absolute top-0 left-0 w-full z-20">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 py-3 sm:py-4 flex items-center justify-between">
            ...
            <div class="flex items-center gap-2 font-heading font-semibold text-lg">
                <img src="{{asset('assets/landing/images/logo.webp')}}" alt="Logo" class="h-12 sm:h-14 md:h-16" />
            </div>
            ...
            <div class="mt-8 sm:mt-10 md:mt-14 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 md:gap-8">
                ...
                <div class="border rounded-xl p-4 sm:p-6 bg-white shadow-sm flex flex-col">
                    ...
                    <div class="mt-4 sm:mt-6 h-40 sm:h-48 w-full overflow-hidden rounded-lg">
                        <img src="{{asset('assets/landing/images/customer-app.svg')}}" alt="Customer App"
                    ...
                    <div
                        ...
                        <a href="https://play.google.com/store/apps/details?id=com.hyperLocal.customer"
                            ...
                            <img src="{{asset('assets/landing/images/playstore.png')}}" alt="Get it on Google Play"
                                class="store-badge">
                        </a>
                        ...
                        <a href="https://testflight.apple.com/join/NmyU7Sa6"
                            ...
                            <img src="{{asset('assets/landing/images/appstore.png')}}" alt="Download on the App Store"
                                class="store-badge">
                        </a>
                    </div>
                </div>
                ...
                <div class="border rounded-xl p-4 sm:p-6 bg-white shadow-sm flex flex-col">
                    ...
                    <div class="mt-4 sm:mt-6 h-40 sm:h-48 w-full overflow-hidden rounded-lg">
                        <img src="{{asset('assets/landing/images/customer-web.svg')}}" alt="Customer Web"
                            class="h-full w-full object-cover object-top" />
                    </div>
                    ...
                    <div class="mt-auto border-t pt-3 text-center">
                        <a href="https://hyperlocal.eshopweb.store" target="_blank"
                            ...
                            <img src="{{asset('assets/landing/images/checkdemo.png')}}" alt="View Customer Web Demo"
                                class="store-badge">
                        </a>
                    </div>
                </div>
                ...
                <div class="border rounded-xl p-4 sm:p-6 bg-white shadow-sm flex flex-col">
                    ...
                    <div class="mt-4 sm:mt-6 h-40 sm:h-48 w-full overflow-hidden rounded-lg">
                        <img src="{{asset('assets/landing/images/admin-panel.svg')}}" alt="Admin Panel"
                            class="h-full w-full object-cover object-top" />
                    </div>
                    ...
                    <div class="mt-auto border-t pt-3 text-center">
                        <a href="https://hyperlocal-backend.eshopweb.store/admin/"
                            ...
                            <img src="{{asset('assets/landing/images/checkdemo.png')}}" alt="View Admin Panel Demo"
                                class="store-badge">
                        </a>
                    </div>
                </div>
                ...
                <div class="border rounded-xl p-4 sm:p-6 bg-white shadow-sm flex flex-col">
                    ...
                    <div class="mt-4 sm:mt-6 h-40 sm:h-48 w-full overflow-hidden rounded-lg">
                        <img src="{{asset('assets/landing/images/seller-panel.svg')}}" alt="Seller Panel"
                            class="h-full w-full object-cover object-top" />
                    </div>
                    ...
                    <div class="mt-auto border-t pt-3 text-center">
                        <a href="https://hyperlocal-backend.eshopweb.store/seller/"
                            ...
                            <img src="{{asset('assets/landing/images/checkdemo.png')}}" alt="View Seller Panel Demo"
                                class="store-badge">
                ...
                <div class="border rounded-xl p-4 sm:p-6 bg-white shadow-sm flex flex-col">
                    ...
                    <div class="mt-4 sm:mt-6 h-40 sm:h-48 w-full overflow-hidden rounded-lg">
                        <img src="{{asset('assets/landing/images/rider-app.svg')}}" alt="Rider App"
                            class="h-full w-full object-cover object-top" />
                    </div>
                    <div
                        class="mt-auto flex justify-between items-center border-t pt-3 text-sm font-medium text-blue-600">
                ...
                <div class="relative rounded-xl p-4 sm:p-6 overflow-hidden bg-[#1f2937] text-white">
                    ...
                    <div class="mt-4 sm:mt-6 h-40 sm:h-48 w-full overflow-hidden rounded-lg relative">
                        <img src="{{asset('assets/landing/images/seller-app.svg')}}" alt="Seller App"
    ...
    <section id="features" class="py-12 sm:py-16 md:py-20 bg-white">
        <div class="max-w-full mx-auto">
            ...
            <div class="text-center max-w-full mx-auto">
                ...
                <img src="{{asset('assets/landing/images/features-mobile.svg')}}" alt="How Hyperlocal Works"
                    class="md:hidden mx-auto block" />
                <img src="{{asset('assets/landing/images/Features.svg')}}" alt="How Hyperlocal Works"
    ...
    <section class="bg-gray-50 py-12 sm:py-16 md:py-20">
        <div class="max-w-7xl mx-auto px-4 sm:px-6">
            ...
            <div class="flex justify-center">
                <!-- Mobile image -->
                <img src="{{ asset('assets/landing/images/how-hyperlocal-works-mobile.svg') }}"
                    alt="How Hyperlocal Works" class="rounded-lg md:hidden" />

                <!-- Desktop image -->
                <img src="{{ asset('assets/landing/images/how-hyperlocal-works.svg') }}" alt="How Hyperlocal Works"
    ...
    <section class="bg-white py-12 sm:py-16 md:py-20">
        <div class="max-w-7xl mx-auto px-4 sm:px-6">
            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 flex justify-center">
                <!-- Mobile -->
                <img src="{{ asset('assets/landing/images/steps--mobile.svg') }}" class="sm:hidden" alt="Steps" />

                <!-- Desktop -->
                <img src="{{ asset('assets/landing/images/steps-desktop.svg') }}" class="hidden w-full h-full sm:block"
                    alt="Steps" />
            </div>
        </div>
    </section>
        ...
        <div class="max-w-6xl mx-auto px-4 sm:px-6">
            ...
            <div class="grid grid-cols-3 sm:grid-cols-3 md:grid-cols-6 gap-4 sm:gap-6">
                ...
                <a href="https://flutter.dev/" target="_blank" rel="noopener noreferrer"
                    ...
                    <img src="{{asset('assets/landing/images/flutter-image.png')}}" alt="Flutter"
                ...
                <a href="https://laravel.com/" target="_blank" rel="noopener noreferrer"
                    ...
                    class="bg-white border border-gray-200 rounded-lg sm:rounded-xl p-4 sm:p-6 md:p-8 flex items-center justify-center hover:shadow-lg transition-shadow">
                    <img src="{{asset('assets/landing/images/laravel-image.png')}}" alt="Laravel"
                        class="w-full h-10 sm:h-12 md:h-16 object-contain" />
                </a>
                ...
                <a href="https://nextjs.org/" target="_blank" rel="noopener noreferrer" title="Learn more about Next.js"
                    class="bg-white border border-gray-200 rounded-lg sm:rounded-xl p-4 sm:p-6 md:p-8 flex items-center justify-center hover:shadow-lg transition-shadow">
                    <img src="{{asset('assets/landing/images/nextjs-image.png')}}" alt="Next.js"
                        class="w-full h-10 sm:h-12 md:h-16 object-contain" />
                </a>
                ...
                <a href="https://firebase.google.com/" target="_blank" rel="noopener noreferrer"
                    ...
                    class="bg-white border border-gray-200 rounded-lg sm:rounded-xl p-4 sm:p-6 md:p-8 flex items-center justify-center hover:shadow-lg transition-shadow">
                    <img src="{{asset('assets/landing/images/firebase-image.png')}}" alt="Firebase"
                        class="w-full h-10 sm:h-12 md:h-16 object-contain" />
                </a>
                ...
                <a href="https://getbootstrap.com/" target="_blank" rel="noopener noreferrer"
                    ...
                    class="bg-white border border-gray-200 rounded-lg sm:rounded-xl p-4 sm:p-6 md:p-8 flex items-center justify-center hover:shadow-lg transition-shadow">
                    <img src="{{asset('assets/landing/images/bootstrap-image.png')}}" alt="Bootstrap"
                        class="w-full h-10 sm:h-12 md:h-16 object-contain" />
                </a>
                ...
                <a href="https://tailwindcss.com/" target="_blank" rel="noopener noreferrer"
                    ...
                    class="bg-white border border-gray-200 rounded-lg sm:rounded-xl p-4 sm:p-6 md:p-8 flex items-center justify-center hover:shadow-lg transition-shadow">
                    <img src="{{asset('assets/landing/images/tailwind-image.png')}}" alt="Tailwind CSS"
                        class="w-full h-10 sm:h-12 md:h-16 object-contain" />
                </a>
            </div>
        </div>
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8 mb-6 sm:mb-8">
                ...
                <div class="lg:col-span-1">
                    <div class="flex items-center gap-3 mb-4">
                        <img src="{{asset('assets/landing/images/footer-logo.png')}}" alt="Logo" class="h-10" />
                    </div>
                </div>
