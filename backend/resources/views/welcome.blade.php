...
<body>
    ...
    <div class="container">
        ...
        <!-- Hero Section -->
        <section class="hero">
            <div class="badge">🚀 Enterprise Delivery Platform</div>
            ...
            <div class="features-list">
                <span>& many more business types — whatever your local market needs.</span>
            </div>
            <div class="button-group">
                <a href="https://wa.me/96178938568" target="_blank" class="link-button" style="text-decoration: none">
                    Talk to Us
                    <span>→</span>
                </a>
            </div>
        ...
        <section class="links-section">
            ...
            <div class="links-grid">
                ...
                <div class="link-card">
                    <div class="link-card-content">
                        ...
                        <div class="app-buttons">
                            ...
                            <a href="https://testflight.apple.com/join/NmyU7Sa6" target="_blank"
                                rel="noopener noreferrer" class="store-button">
                                <img src="https://tools.applemediaservices.com/api/badges/download-on-the-app-store/black/en-us?size=250x83&amp;releaseDate=1301616000"
                ...
                <!-- Vendor Website -->
                <a href="https://hyperlocal-backend.eshopweb.store/seller/login" target="_blank"
                ...
                <div class="link-card">
                    <div class="link-card-content">
                        ...
                        <p class="link-description">
                            Real-time order tracking and navigation for delivery partners. Accept and complete
                            deliveries.
                        </p>
                        <div class="app-buttons">
                            ...
                            <a href="https://testflight.apple.com/join/tmK8cP9Y" target="_blank"
                                rel="noopener noreferrer" class="store-button">
                                <img src="https://tools.applemediaservices.com/api/badges/download-on-the-app-store/black/en-us?size=250x83&amp;releaseDate=1301616000"
                                    alt="Download on the App Store" class="store-badge">
                            </a>
                ...
                <!-- Admin Panel -->
                <a href="https://hyperlocal-backend.eshopweb.store/admin/login" target="_blank"
                    rel="noopener noreferrer" class="link-card">
                    <div class="link-card-content">
        ...
        <footer>
            ...
            <p class="footer-text developer-credit">
                Powered by <a href="https://codetroops.net/" target="_blank" rel="noopener">Code Troops</a>
            </p>
        </footer>
    </div>
